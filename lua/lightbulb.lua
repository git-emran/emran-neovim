...
--- Implementation inspired from https://github.com/nvimdev/lspsaga.nvim/blob/8efe00d6aed9db6449969f889170f1a7e43101a1/lua/lspsaga/codeaction/lightbulb.lua

local M = {}

local lb_name = 'emran/lightbulb'
